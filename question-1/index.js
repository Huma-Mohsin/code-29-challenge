...
function find_Occurence_Of_Word(sentence) {
    var position1 = sentence.indexOf("code");
    var position2 = sentence.indexOf("CODE"); //consider a word not found ,it returns the output as -1.
    return [position1, position2]; //it returns the indexes in a list form
}
var sentence = "Within the binary whispers of ones and zeros, code breathes life into the machinery of progress, scripting the narrative of a digital evolution.";
